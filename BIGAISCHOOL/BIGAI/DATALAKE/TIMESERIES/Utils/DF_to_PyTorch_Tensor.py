...
class PyTorchDataPreparator():
    ...
    def GetDataPrepared(self, batch_size, time_steps, train_perc, val_perc, test_perc, target):
        ...
        target_train_t, target_val_t, target_test_t = self.df_to_tensor(self.data, self.batch_size, self.time_steps, self.train_perc, self.val_perc, self.test_perc , self.target)
